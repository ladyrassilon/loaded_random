...
from loaded import RandomGen, SystemRandomGen
...
class TestRandomGen(unittest.TestCase):
    ...
    def test_longer_probabilities_list(self):
        ...
        with self.assertRaises(IndexError):
            load = self.random_generator(random_nums=random_nums, probabilities=probabilities)
...
class TestSystemRandomGen(TestRandomGen):
    random_generator = SystemRandomGen